...
const arrOfProjects = [
  ...
  },
  {
    ...
    description: 'Inspired by the amazing company SpaceX, we built a mock website to showcase info about this company, like rockets and missions. It allows you to reserve rockets and a missions at will. You can then view all your reserved rockets and missions in your profile page. We built this website using React and Redux and we style it using React Bootstrap.',
  ...
  },
  {
    ...
    description: '"Math Magicians" is an app for mathlovers. It contains a calculator for doing operations! It was created using React and SASS.',
  ...
  },
  {
    ...
    title: 'Bookstore',
    languages: ['React', 'Redux', 'SASS', 'Axios'],
    description: 'This is an app to store the books you are reading. It uses an API to store and fetch the data to track your progress. It was created using React and Redux. Styled using SASS.',
